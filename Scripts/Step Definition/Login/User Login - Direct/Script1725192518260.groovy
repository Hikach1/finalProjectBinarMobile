...
WebUI.callTestCase(findTestCase('Pages/Login Page/Set Email'), setemail, FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Login Page/Set Password'), setpassword, FailureHandling.STOP_ON_FAILURE)
